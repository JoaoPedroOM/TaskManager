      ...
      <main className="lg:mb-[120px] lg:my-[120px] my-14">
        <div className="flex flex-col justify-center items-center gap-8">
          <motion.h1
            ...
            className="font-main lg:leading-[1.2] text-center lg:w-1/2 w-full lg:text-5xl lg:px-0 px-2 text-3xl font-bold text-[#d4d5d6]"
          >
           <Highlight>Melhoria na Produtividade</Highlight> e Gestão de Tarefas
          </motion.h1>
          ...
          <motion.p
            ...
            animate={{ opacity: 1, y: [20, -5, 0] }}
            transition={{ duration: 0.5, ease: [0.4, 0.0, 0.2, 1] }}
            className="font-titles text-center font-light lg:text-xl text-base lg:px-0 px-2 text-[#a9abad]"
          >
